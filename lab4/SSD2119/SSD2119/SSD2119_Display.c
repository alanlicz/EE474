...
static void LCD_GPIOInit(void){
    ...
    GPIO_PORTD_AFSEL_R &= 0x3;                  // disable alternate functions
    ...
    GPIO_PORTK_AFSEL_R &= 0x1F;                 // disable alternate functions
    ...
    GPIO_PORTM_AFSEL_R &= 0x7F                  // disable alternate functions
    ...
    GPIO_PORTN_AFSEL_R &= 0xF                   // disable alternate functions
    ...
    GPIO_PORTP_AFSEL_R &= 0x4;                  // disable alternate functions
    ...
    GPIO_PORTQ_AFSEL_R &= 0x2;                  // disable alternate functions
